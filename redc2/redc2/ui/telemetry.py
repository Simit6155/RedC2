"""Compact live graphs for CPU/RAM/temperature history.

Uses Textual's built-in Sparkline widget so we get clean rendering without
opening any external plotting window, matching the "Textual/Rich-compatible
...
class TelemetryGraphs(Vertical):
    """Three stacked sparklines: CPU, RAM, temperature."""
